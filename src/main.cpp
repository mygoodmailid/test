...
uint256 hashGenesisBlock("0x74f2a8f92edecf076d81b8029b94505311fc9ea3d51baf368a76f2a7afdf85c1");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Mycoin: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x420b4558cccb4827fbb1c4d700994983754b48ec50cac07a949a7224e37204c5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Greetings..";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04811ba435861bd720df55e5aba2a7f7d635f222d15a92ed84ecdba94f76b9aca8dd1f5fe5332a5399748735ad1d6b4a34eccc4feb0d7f7e40f1970dbf58bd5b9e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1521428240;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085196097;

        if (fTestNet)
        {
            block.nTime    = 1521428263;
            block.nNonce   = 388723953;
        }
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x68524ca37b5dc43c01885d70a4d1e7f38ba077ae8759810fb52577a6057ee326"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb7, 0xdc }; // Mycoin: increase each by adding 2 to bitcoin's value.
